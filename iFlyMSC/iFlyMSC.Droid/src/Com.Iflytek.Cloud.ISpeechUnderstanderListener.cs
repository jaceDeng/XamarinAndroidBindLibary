...
namespace Com.Iflytek.Cloud {
	...
	// Metadata.xml XPath interface reference: path="/api/package[@name='com.iflytek.cloud']/interface[@name='SpeechUnderstanderListener']"
	[Register ("com/iflytek/cloud/SpeechUnderstanderListener", "", "Com.Iflytek.Cloud.ISpeechUnderstanderListenerInvoker")]
	public partial interface ISpeechUnderstanderListener : IJavaObject, IJavaPeerable {

		// Metadata.xml XPath method reference: path="/api/package[@name='com.iflytek.cloud']/interface[@name='SpeechUnderstanderListener']/method[@name='onBeginOfSpeech' and count(parameter)=0]"
		[Register ("onBeginOfSpeech", "()V", "GetOnBeginOfSpeechHandler:Com.Iflytek.Cloud.ISpeechUnderstanderListenerInvoker, iFlyMSC.Droid")]
		void OnBeginOfSpeech ();

		// Metadata.xml XPath method reference: path="/api/package[@name='com.iflytek.cloud']/interface[@name='SpeechUnderstanderListener']/method[@name='onEndOfSpeech' and count(parameter)=0]"
		[Register ("onEndOfSpeech", "()V", "GetOnEndOfSpeechHandler:Com.Iflytek.Cloud.ISpeechUnderstanderListenerInvoker, iFlyMSC.Droid")]
		void OnEndOfSpeech ();

		// Metadata.xml XPath method reference: path="/api/package[@name='com.iflytek.cloud']/interface[@name='SpeechUnderstanderListener']/method[@name='onError' and count(parameter)=1 and parameter[1][@type='com.iflytek.cloud.SpeechError']]"
		[Register ("onError", "(Lcom/iflytek/cloud/SpeechError;)V", "GetOnError_Lcom_iflytek_cloud_SpeechError_Handler:Com.Iflytek.Cloud.ISpeechUnderstanderListenerInvoker, iFlyMSC.Droid")]
		void OnError (global::Com.Iflytek.Cloud.SpeechError p0);

		// Metadata.xml XPath method reference: path="/api/package[@name='com.iflytek.cloud']/interface[@name='SpeechUnderstanderListener']/method[@name='onEvent' and count(parameter)=4 and parameter[1][@type='int'] and parameter[2][@type='int'] and parameter[3][@type='int'] and parameter[4][@type='android.os.Bundle']]"
		[Register ("onEvent", "(IIILandroid/os/Bundle;)V", "GetOnEvent_IIILandroid_os_Bundle_Handler:Com.Iflytek.Cloud.ISpeechUnderstanderListenerInvoker, iFlyMSC.Droid")]
		void OnEvent (int p0, int p1, int p2, global::Android.OS.Bundle p3);

		// Metadata.xml XPath method reference: path="/api/package[@name='com.iflytek.cloud']/interface[@name='SpeechUnderstanderListener']/method[@name='onResult' and count(parameter)=1 and parameter[1][@type='com.iflytek.cloud.UnderstanderResult']]"
		[Register ("onResult", "(Lcom/iflytek/cloud/UnderstanderResult;)V", "GetOnResult_Lcom_iflytek_cloud_UnderstanderResult_Handler:Com.Iflytek.Cloud.ISpeechUnderstanderListenerInvoker, iFlyMSC.Droid")]
		void OnResult (global::Com.Iflytek.Cloud.UnderstanderResult p0);

		// Metadata.xml XPath method reference: path="/api/package[@name='com.iflytek.cloud']/interface[@name='SpeechUnderstanderListener']/method[@name='onVolumeChanged' and count(parameter)=2 and parameter[1][@type='int'] and parameter[2][@type='byte[]']]"
		[Register ("onVolumeChanged", "(I[B)V", "GetOnVolumeChanged_IarrayBHandler:Com.Iflytek.Cloud.ISpeechUnderstanderListenerInvoker, iFlyMSC.Droid")]
		void OnVolumeChanged (int p0, byte[] p1);

	}

	[global::Android.Runtime.Register ("com/iflytek/cloud/SpeechUnderstanderListener", DoNotGenerateAcw=true)]
	internal partial class ISpeechUnderstanderListenerInvoker : global::Java.Lang.Object, ISpeechUnderstanderListener {

		static readonly JniPeerMembers _members = new XAPeerMembers ("com/iflytek/cloud/SpeechUnderstanderListener", typeof (ISpeechUnderstanderListenerInvoker));
		...
		static IntPtr Validate (IntPtr handle)
		{
			if (!JNIEnv.IsInstanceOf (handle, java_class_ref))
				throw new InvalidCastException (string.Format ("Unable to convert instance of type '{0}' to type '{1}'.",
							JNIEnv.GetClassNameFromInstance (handle), "com.iflytek.cloud.SpeechUnderstanderListener"));
			return handle;
		}
...
#pragma warning disable 0169
		...
		{
			var __this = global::Java.Lang.Object.GetObject<global::Com.Iflytek.Cloud.ISpeechUnderstanderListener> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
	...
	// event args for com.iflytek.cloud.SpeechUnderstanderListener.onError
 
	// event args for com.iflytek.cloud.SpeechUnderstanderListener.onEvent
 

	// event args for com.iflytek.cloud.SpeechUnderstanderListener.onResult
	 

	// event args for com.iflytek.cloud.SpeechUnderstanderListener.onVolumeChanged
 

	[global::Android.Runtime.Register ("mono/com/iflytek/cloud/SpeechUnderstanderListenerImplementor")]
	internal sealed partial class ISpeechUnderstanderListenerImplementor : global::Java.Lang.Object, ISpeechUnderstanderListener {

		object sender;

		public ISpeechUnderstanderListenerImplementor (object sender)
			: base (
				global::Android.Runtime.JNIEnv.StartCreateInstance ("mono/com/iflytek/cloud/SpeechUnderstanderListenerImplementor", "()V"),
...
#pragma warning restore 0649
		...
		internal static bool __IsEmpty (ISpeechUnderstanderListenerImplementor value)
		{
